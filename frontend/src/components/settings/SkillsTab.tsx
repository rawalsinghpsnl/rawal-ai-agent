    ...
    <div className="space-y-5">
      <div>
        ...
        <p className="text-[12.5px] text-muted-foreground">
          Standard <code className="rounded bg-muted px-1 font-mono">SKILL.md</code> packs.
        ...
        {method === "github" && (
          <div className="space-y-2 rounded-xl border border-border bg-surface p-3">
            <p className="text-[12px] text-muted-foreground">
              Any public repo — <code className="font-mono">owner/repo</code>, <code className="font-mono">owner/repo@branch</code> or a subpath. Works with community skill repos.
            </p>
            <div className="flex gap-2">
              <Input value={repo} onChange={(e) => setRepo(e.target.value)} placeholder="owner/skills-repo" className="h-8 flex-1 font-mono text-xs" />
              <Button
                size="sm"
                variant="outline"
