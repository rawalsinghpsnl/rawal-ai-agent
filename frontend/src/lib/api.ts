...
const TOKEN_KEY = "rawal.token";
const LEGACY_TOKEN_KEY = "bhati.token";

// One-time migration: rawal-ai-agent rebrand (v2). Preserve existing logins.
try {
...
/**
 * Short display label for a model id (last path segment).
 */
