...
- Custom proxies (self-hosted gateways, local servers, and OpenAI-style endpoints)
...
class LLMClient:
    ...
    def _headers(self) -> dict[str, str]:
        headers = {
            ...
            "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/128.0.0.0 Safari/537.36 RawalAiAgent/2.0",
    ...
    async def _stream_openai(
        ...
        # Retry logic for Render cold start / temporary provider errors
        max_retries = 3
        backoff = 2.0
